...
gulp.task('declaration-commonjs', () => {
    return typingsUtil.commonjs('./types', '@irysius/anguli-components', './build');
});
gulp.task('declaration-amd', () => {
    return typingsUtil.amd('./types', '@irysius/anguli-components', './tests/project.d.ts');
});
...
gulp.task('setup-test', () => {
    ...
    return gulp.src([
        'build/**/*.*'
    ]).pipe(gulp.dest('./node_modules/@irysius/anguli-components/'));
});
